...
HXLINE(  73)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_pixel_latin_ttf >());
...
HXLINE(  82)		{
HXLINE(  82)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/libvlc.json",6e,60,b6,a2));
HXDLIN(  82)			::lime::utils::Assets_obj::libraryPaths->set(HX_("libvlc",48,b2,be,e4),v);
            		}
HXLINE(  83)		{
HXLINE(  83)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  83)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v1);
            		}
...
HXLINE(  88)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
