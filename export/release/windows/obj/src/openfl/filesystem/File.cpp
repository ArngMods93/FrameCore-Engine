...
HXLINE( 954)		this->_hx___fileWorker =  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXLINE(1077)		this->_hx___fileWorker =  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXLINE(1148)		this->_hx___fileWorker =  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXLINE(1258)		this->_hx___fileWorker =  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXLINE(1529)		this->_hx___fileWorker =  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null());
...
::hx::Val File_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__fileWorker") ) { _hx___fileWorker=inValue.Cast<  ::lime::_hx_system::ThreadPool >(); return inValue; }
		break;
	case 16:
