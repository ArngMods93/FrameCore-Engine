...
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),(val & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val1 = (::hx::UShr(destPixel,16) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),(val1 & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val2 = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),(val2 & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val3 = (destPixel & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),(val3 & 255));
            									}
            								}
            								break;
            								case (int)1: {
...
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),(val4 & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val5 = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),(val5 & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val6 = (::hx::UShr(destPixel,16) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),(val6 & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val7 = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),(val7 & 255));
            									}
            								}
            								break;
            								case (int)2: {
...
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),(val8 & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val9 = (::hx::UShr(destPixel,16) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),(val9 & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val10 = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),(val10 & 255));
            									}
HXDLIN( 211)									{
HXLINE( 211)										int val11 = (destPixel & 255);
HXDLIN( 211)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),(val11 & 255));
            									}
            								}
            								break;
            							}
