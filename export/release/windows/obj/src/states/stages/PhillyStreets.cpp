...
HX_LOCAL_STACK_FRAME(_hx_pos_06ef21b7f8b4c92f_219_videoCutscene,"states.stages.PhillyStreets","videoCutscene",0xe84dcd92,"states.stages.PhillyStreets.videoCutscene","states/stages/PhillyStreets.hx",219,0xc5ad7ea3)
...
void PhillyStreets_obj::videoCutscene(::String videoName){
            	HX_STACKFRAME(&_hx_pos_06ef21b7f8b4c92f_212_videoCutscene)
...
HXDLIN( 214)		if (_hx_tmp) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::states::stages::PhillyStreets,_gthis) HXARGC(0)
            			void _hx_run(){
            				HX_STACKFRAME(&_hx_pos_06ef21b7f8b4c92f_219_videoCutscene)
HXLINE( 220)				_gthis->videoEnded = true;
HXLINE( 221)				::flixel::FlxG_obj::game->_state->__SetField(HX_("videoCutscene",25,60,e8,9c),null(),::hx::paccDynamic);
HXLINE( 222)				_gthis->videoCutscene(null());
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 217)			::flixel::FlxG_obj::game->_state->__Field(HX_("startVideo",b9,ec,12,53),::hx::paccDynamic)(videoName);
HXLINE( 218)			 ::Dynamic(::flixel::FlxG_obj::game->_state->__Field(HX_("videoCutscene",25,60,e8,9c),::hx::paccDynamic))->__SetField(HX_("finishCallback",38,a1,bc,b4),( ::Dynamic(::flixel::FlxG_obj::game->_state->__Field(HX_("videoCutscene",25,60,e8,9c),::hx::paccDynamic))->__SetField(HX_("onSkip",3e,1f,df,ee), ::Dynamic(new _hx_Closure_0(_gthis)),::hx::paccDynamic)),::hx::paccDynamic);
HXLINE( 232)			return;
            		}
