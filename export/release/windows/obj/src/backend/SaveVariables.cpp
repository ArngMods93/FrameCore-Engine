...
void SaveVariables_obj::__construct( ::Dynamic downScroll, ::Dynamic middleScroll, ::Dynamic opponentStrums, ::Dynamic showFPS, ::Dynamic flashing, ::Dynamic autoPause, ::Dynamic antialiasing,::String noteSkin,::String splashSkin, ::Dynamic splashAlpha,::String holdSkin, ::Dynamic holdSplashAlpha, ::Dynamic lowQuality, ::Dynamic shaders, ::Dynamic cacheOnGPU, ::Dynamic framerate,::String tpsMode, ::Dynamic tpsFixed, ::Dynamic tpsDynamicMin, ::Dynamic tpsDynamicMax, ::Dynamic showTPS, ::Dynamic camZooms, ::Dynamic hideHud, ::Dynamic noteOffset,::Array< ::Dynamic> arrowRGB,::Array< ::Dynamic> arrowRGBPixel, ::Dynamic ghostTapping,::String timeBarType, ::Dynamic scoreZoom, ::Dynamic noReset, ::Dynamic healthBarAlpha, ::Dynamic hitsoundVolume,::String pauseMusic, ::Dynamic checkForUpdates, ::Dynamic comboStacking, ::haxe::ds::StringMap gameplaySettings,::Array< int > comboOffset, ::Dynamic ratingOffset, ::Dynamic sickWindow, ::Dynamic goodWindow, ::Dynamic badWindow, ::Dynamic safeFrames, ::Dynamic guitarHeroSustains, ::Dynamic discordRPC, ::Dynamic loadingScreen,::String language,::String colorblindMode){
            	HX_GC_STACKFRAME(&_hx_pos_c0fe648b9977b22a_10_new)
HXLINE(  88)		this->colorblindMode = HX_("None",d8,3e,e3,33);
HXLINE(  87)		this->language = HX_("en-US",02,7f,50,70);
HXLINE(  86)		this->loadingScreen = true;
HXLINE(  85)		this->discordRPC = true;
HXLINE(  84)		this->guitarHeroSustains = true;
HXLINE(  83)		this->safeFrames = ((Float)10.0);
HXLINE(  82)		this->badWindow = ((Float)135.0);
HXLINE(  81)		this->goodWindow = ((Float)90.0);
HXLINE(  80)		this->sickWindow = ((Float)45.0);
HXLINE(  79)		this->ratingOffset = 0;
HXLINE(  78)		this->comboOffset = ::Array_obj< int >::fromData( _hx_array_data_d0f3e9c0_1,4);
HXLINE(  56)		 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN(  56)		_g->set(HX_("scrollspeed",5a,70,19,38),((Float)1.0));
HXDLIN(  56)		_g->set(HX_("scrolltype",47,55,ef,1f),HX_("multiplicative",96,7a,3f,fa));
HXDLIN(  56)		_g->set(HX_("songspeed",92,6f,b6,1d),((Float)1.0));
HXDLIN(  56)		_g->set(HX_("healthgain",1b,97,1b,16),((Float)1.0));
HXDLIN(  56)		_g->set(HX_("healthloss",7f,50,74,19),((Float)1.0));
HXDLIN(  56)		_g->set(HX_("instakill",f9,72,23,49),false);
HXDLIN(  56)		_g->set(HX_("practice",bb,00,e7,a0),false);
HXDLIN(  56)		_g->set(HX_("botplay",7b,fb,a9,61),false);
HXDLIN(  56)		_g->set(HX_("opponentplay",11,7a,4c,86),false);
HXDLIN(  56)		this->gameplaySettings = _g;
...
HXLINE(  32)		this->showTPS = true;
HXLINE(  31)		this->tpsDynamicMax = 240;
HXLINE(  30)		this->tpsDynamicMin = 60;
HXLINE(  29)		this->tpsFixed = 60;
HXLINE(  28)		this->tpsMode = HX_("Sync",7b,e6,38,37);
HXLINE(  26)		this->framerate = 60;
HXLINE(  25)		this->cacheOnGPU = false;
HXLINE(  24)		this->shaders = true;
HXLINE(  23)		this->lowQuality = false;
HXLINE(  22)		this->holdSplashAlpha = ((Float)0.6);
HXLINE(  21)		this->holdSkin = HX_("default",c1,d8,c3,9b);
...
HXDLIN(  10)			this->holdSkin = holdSkin;
            		}
...
HXDLIN(  10)		if (::hx::IsNotNull( tpsMode )) {
HXDLIN(  10)			this->tpsMode = tpsMode;
            		}
HXDLIN(  10)		if (::hx::IsNotNull( tpsFixed )) {
HXDLIN(  10)			this->tpsFixed = ( (int)(tpsFixed) );
            		}
HXDLIN(  10)		if (::hx::IsNotNull( tpsDynamicMin )) {
HXDLIN(  10)			this->tpsDynamicMin = ( (int)(tpsDynamicMin) );
            		}
HXDLIN(  10)		if (::hx::IsNotNull( tpsDynamicMax )) {
HXDLIN(  10)			this->tpsDynamicMax = ( (int)(tpsDynamicMax) );
            		}
HXDLIN(  10)		if (::hx::IsNotNull( showTPS )) {
HXDLIN(  10)			this->showTPS = ( (bool)(showTPS) );
            		}
...
HXDLIN(  10)		if (::hx::IsNotNull( colorblindMode )) {
HXDLIN(  10)			this->colorblindMode = colorblindMode;
            		}
            	}
...
::hx::ObjectPtr< SaveVariables_obj > SaveVariables_obj::__new( ::Dynamic downScroll, ::Dynamic middleScroll, ::Dynamic opponentStrums, ::Dynamic showFPS, ::Dynamic flashing, ::Dynamic autoPause, ::Dynamic antialiasing,::String noteSkin,::String splashSkin, ::Dynamic splashAlpha,::String holdSkin, ::Dynamic holdSplashAlpha, ::Dynamic lowQuality, ::Dynamic shaders, ::Dynamic cacheOnGPU, ::Dynamic framerate,::String tpsMode, ::Dynamic tpsFixed, ::Dynamic tpsDynamicMin, ::Dynamic tpsDynamicMax, ::Dynamic showTPS, ::Dynamic camZooms, ::Dynamic hideHud, ::Dynamic noteOffset,::Array< ::Dynamic> arrowRGB,::Array< ::Dynamic> arrowRGBPixel, ::Dynamic ghostTapping,::String timeBarType, ::Dynamic scoreZoom, ::Dynamic noReset, ::Dynamic healthBarAlpha, ::Dynamic hitsoundVolume,::String pauseMusic, ::Dynamic checkForUpdates, ::Dynamic comboStacking, ::haxe::ds::StringMap gameplaySettings,::Array< int > comboOffset, ::Dynamic ratingOffset, ::Dynamic sickWindow, ::Dynamic goodWindow, ::Dynamic badWindow, ::Dynamic safeFrames, ::Dynamic guitarHeroSustains, ::Dynamic discordRPC, ::Dynamic loadingScreen,::String language,::String colorblindMode) {
	...
	__this->__construct(downScroll,middleScroll,opponentStrums,showFPS,flashing,autoPause,antialiasing,noteSkin,splashSkin,splashAlpha,holdSkin,holdSplashAlpha,lowQuality,shaders,cacheOnGPU,framerate,tpsMode,tpsFixed,tpsDynamicMin,tpsDynamicMax,showTPS,camZooms,hideHud,noteOffset,arrowRGB,arrowRGBPixel,ghostTapping,timeBarType,scoreZoom,noReset,healthBarAlpha,hitsoundVolume,pauseMusic,checkForUpdates,comboStacking,gameplaySettings,comboOffset,ratingOffset,sickWindow,goodWindow,badWindow,safeFrames,guitarHeroSustains,discordRPC,loadingScreen,language,colorblindMode);
	return __this;
}
...
void SaveVariables_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(tpsMode,"tpsMode");
	HX_MARK_MEMBER_NAME(tpsFixed,"tpsFixed");
	HX_MARK_MEMBER_NAME(tpsDynamicMin,"tpsDynamicMin");
	HX_MARK_MEMBER_NAME(tpsDynamicMax,"tpsDynamicMax");
	HX_MARK_MEMBER_NAME(showTPS,"showTPS");
	...
	HX_MARK_MEMBER_NAME(colorblindMode,"colorblindMode");
	HX_MARK_END_CLASS();
}
...
void SaveVariables_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(tpsMode,"tpsMode");
	HX_VISIT_MEMBER_NAME(tpsFixed,"tpsFixed");
	HX_VISIT_MEMBER_NAME(tpsDynamicMin,"tpsDynamicMin");
	HX_VISIT_MEMBER_NAME(tpsDynamicMax,"tpsDynamicMax");
	HX_VISIT_MEMBER_NAME(showTPS,"showTPS");
	...
	HX_VISIT_MEMBER_NAME(colorblindMode,"colorblindMode");
}
...
::hx::Val SaveVariables_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"tpsMode") ) { return ::hx::Val( tpsMode ); }
		if (HX_FIELD_EQ(inName,"showTPS") ) { return ::hx::Val( showTPS ); }
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"tpsFixed") ) { return ::hx::Val( tpsFixed ); }
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"tpsDynamicMin") ) { return ::hx::Val( tpsDynamicMin ); }
		if (HX_FIELD_EQ(inName,"tpsDynamicMax") ) { return ::hx::Val( tpsDynamicMax ); }
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"colorblindMode") ) { return ::hx::Val( colorblindMode ); }
		break;
	case 15:
...
::hx::Val SaveVariables_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"tpsMode") ) { tpsMode=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"showTPS") ) { showTPS=inValue.Cast< bool >(); return inValue; }
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"holdSkin") ) { holdSkin=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpsFixed") ) { tpsFixed=inValue.Cast< int >(); return inValue; }
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"tpsDynamicMin") ) { tpsDynamicMin=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpsDynamicMax") ) { tpsDynamicMax=inValue.Cast< int >(); return inValue; }
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"colorblindMode") ) { colorblindMode=inValue.Cast< ::String >(); return inValue; }
		break;
	case 15:
...
void SaveVariables_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("tpsMode",7a,ee,00,0a));
	outFields->push(HX_("tpsFixed",7d,92,19,ab));
	outFields->push(HX_("tpsDynamicMin",aa,a9,b8,ab));
	outFields->push(HX_("tpsDynamicMax",bc,a2,b8,ab));
	outFields->push(HX_("showTPS",7a,aa,a4,7b));
	...
	outFields->push(HX_("colorblindMode",95,89,67,78));
...
static ::hx::StorageInfo SaveVariables_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(SaveVariables_obj,tpsMode),HX_("tpsMode",7a,ee,00,0a)},
	{::hx::fsInt,(int)offsetof(SaveVariables_obj,tpsFixed),HX_("tpsFixed",7d,92,19,ab)},
	{::hx::fsInt,(int)offsetof(SaveVariables_obj,tpsDynamicMin),HX_("tpsDynamicMin",aa,a9,b8,ab)},
	{::hx::fsInt,(int)offsetof(SaveVariables_obj,tpsDynamicMax),HX_("tpsDynamicMax",bc,a2,b8,ab)},
	{::hx::fsBool,(int)offsetof(SaveVariables_obj,showTPS),HX_("showTPS",7a,aa,a4,7b)},
	...
	{::hx::fsString,(int)offsetof(SaveVariables_obj,colorblindMode),HX_("colorblindMode",95,89,67,78)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String SaveVariables_obj_sMemberFields[] = {
	...
	HX_("tpsMode",7a,ee,00,0a),
	HX_("tpsFixed",7d,92,19,ab),
	HX_("tpsDynamicMin",aa,a9,b8,ab),
	HX_("tpsDynamicMax",bc,a2,b8,ab),
	HX_("showTPS",7a,aa,a4,7b),
	...
	HX_("colorblindMode",95,89,67,78),
	::String(null()) };
