...
HXLINE( 759)				::backend::DiscordClient_obj::set_clientID(HX_("1521144214644199485",2f,85,46,64));
...
HXLINE(1282)		{
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_124, ::states::PlayState,game) HXARGC(5)
...
HXLINE(1284)				if (::sys::FileSystem_obj::exists(::backend::Paths_obj::video(videoFile))) {
HXLINE(1286)					if (::hx::IsNotNull( game->videoCutscene )) {
HXLINE(1288)						game->remove(game->videoCutscene,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE(1289)						game->videoCutscene->destroy();
            					}
HXLINE(1291)					game->videoCutscene = game->startVideo(videoFile,forMidSong,canSkip,shouldLoop,playOnLoad);
HXLINE(1292)					return true;
            				}
            				else {
HXLINE(1296)					::psychlua::FunkinLua_obj::luaTrace((HX_("startVideo: Video file not found: ",fb,91,b5,c8) + videoFile),false,false,-65536);
            				}
HXLINE(1298)				return false;
            			}
            			HX_END_LOCAL_FUNC5(return)

HXLINE(1282)			 cpp::Reference<lua_State> l110 = this->lua;
HXDLIN(1282)			::llua::Lua_helper_obj::callbacks->set(HX_("startVideo",b9,ec,12,53), ::Dynamic(new _hx_Closure_124(game)));
...
HXDLIN(1314)			::llua::Lua_helper_obj::callbacks->set(HX_("playMusic",11,fe,3e,31), ::Dynamic(new _hx_Closure_125()));
HXDLIN(1314)			linc::callbacks::add_callback_function(l111,HX_("playMusic",11,fe,3e,31));
            		}
HXLINE(1317)		{
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_127, ::states::PlayState,game) HXARGC(4)
...
HXLINE(1330)					{
            						HX_BEGIN_LOCAL_FUNC_S5(::hx::LocalFunc,_hx_Closure_126, ::states::PlayState,game,::String,originalTag,::Array< ::String >,tag1, ::haxe::ds::StringMap,variables, ::Dynamic,loop) HXARGC(0)
            						void _hx_run(){
...
HXDLIN(1330)						 ::Dynamic value2 = value->play(value1,volume,loop,null(),true, ::Dynamic(new _hx_Closure_126(game,originalTag,tag1,variables,loop)));
...
HXDLIN(1317)			::llua::Lua_helper_obj::callbacks->set(HX_("playSound",3b,ba,b0,a1), ::Dynamic(new _hx_Closure_127(game)));
...
HXDLIN(1340)			::llua::Lua_helper_obj::callbacks->set(HX_("stopSound",6d,c5,0e,91), ::Dynamic(new _hx_Closure_128()));
...
HXDLIN(1358)			::llua::Lua_helper_obj::callbacks->set(HX_("pauseSound",f9,29,45,56), ::Dynamic(new _hx_Closure_129()));
...
HXDLIN(1371)			::llua::Lua_helper_obj::callbacks->set(HX_("resumeSound",e2,5f,96,51), ::Dynamic(new _hx_Closure_130()));
HXDLIN(1371)			linc::callbacks::add_callback_function(l115,HX_("resumeSound",e2,5f,96,51));
            		}
HXLINE(1384)		{
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_131) HXARGC(4)
...
HXDLIN(1384)			::llua::Lua_helper_obj::callbacks->set(HX_("soundFadeIn",b0,52,d8,97), ::Dynamic(new _hx_Closure_131()));
...
HXDLIN(1398)			::llua::Lua_helper_obj::callbacks->set(HX_("soundFadeOut",63,9b,74,45), ::Dynamic(new _hx_Closure_132()));
...
HXDLIN(1412)			::llua::Lua_helper_obj::callbacks->set(HX_("soundFadeCancel",c5,a5,96,fc), ::Dynamic(new _hx_Closure_133()));
...
HXDLIN(1426)			::llua::Lua_helper_obj::callbacks->set(HX_("getSoundVolume",13,83,1e,9a), ::Dynamic(new _hx_Closure_134()));
...
HXDLIN(1440)			::llua::Lua_helper_obj::callbacks->set(HX_("setSoundVolume",87,6b,3e,ba), ::Dynamic(new _hx_Closure_135()));
...
HXDLIN(1457)			::llua::Lua_helper_obj::callbacks->set(HX_("getSoundTime",06,35,21,67), ::Dynamic(new _hx_Closure_136()));
...
HXDLIN(1466)			::llua::Lua_helper_obj::callbacks->set(HX_("setSoundTime",7a,58,1a,7c), ::Dynamic(new _hx_Closure_137()));
...
HXDLIN(1482)			::llua::Lua_helper_obj::callbacks->set(HX_("getSoundPitch",a7,2c,58,88), ::Dynamic(new _hx_Closure_138()));
HXDLIN(1482)			linc::callbacks::add_callback_function(l123,HX_("getSoundPitch",a7,2c,58,88));
            		}
HXLINE(1492)		{
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_139) HXARGC(3)
...
HXDLIN(1492)			::llua::Lua_helper_obj::callbacks->set(HX_("setSoundPitch",b3,0e,5e,cd), ::Dynamic(new _hx_Closure_139()));
HXDLIN(1492)			linc::callbacks::add_callback_function(l124,HX_("setSoundPitch",b3,0e,5e,cd));
            		}
HXLINE(1532)		this->addLocalCallback(HX_("getModSetting",24,8b,81,ff), ::Dynamic(new _hx_Closure_140(_gthis)));
HXLINE(1550)		{
...
HXDLIN(1550)			::llua::Lua_helper_obj::callbacks->set(HX_("debugPrint",da,28,6f,c7), ::Dynamic(new _hx_Closure_141()));
HXDLIN(1550)			linc::callbacks::add_callback_function(l125,HX_("debugPrint",da,28,6f,c7));
            		}
HXLINE(1552)		this->addLocalCallback(HX_("close",b8,17,63,48), ::Dynamic(new _hx_Closure_142(_gthis,scriptName1)));
