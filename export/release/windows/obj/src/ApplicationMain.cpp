...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FrameCoreEngine",ee,a8,df,8d),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("ArgMods",c7,08,22,a5));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("FrameCoreEngine",ee,a8,df,8d));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': FrameCore Engine",c9,a2,b3,5f));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.stefandx.framecoreengine",30,2c,4b,64));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.3.0",f7,83,ca,c1));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': FrameCore Engine",c9,a2,b3,5f))
