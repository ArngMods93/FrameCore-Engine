...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FrameCoreEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FrameCoreEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "2";
		app.meta["company"] = "ArgMods";
		app.meta["file"] = "FrameCoreEngine";
		app.meta["name"] = "Friday Night Funkin': FrameCore Engine";
		app.meta["packageName"] = "com.stefandx.framecoreengine";
		app.meta["version"] = "0.3.0";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': FrameCore Engine",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': FrameCore Engine";
		#else
