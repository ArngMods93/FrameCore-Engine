...
@:structInit class SaveVariables {
	...
	// TPS Mode (FrameCore)
	public var tpsMode:String = 'Sync'; // Sync / Fixed / Dynamic
	public var tpsFixed:Int = 60;
	public var tpsDynamicMin:Int = 60;
	public var tpsDynamicMax:Int = 240;
	public var showTPS:Bool = true;
...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		backend.ColorAccessibility.apply(data.colorblindMode);
