...
class FPSCounter extends TextField
{
	...
	**/
	public static var engineVersion:String = "2.0";

	/**
		Texto extra que se le pega al final de la versión, ej: "Release"
	...
	**/
	...
	public dynamic function updateText():Void { // so people can override it in hscript
		text = 'FPS: ${currentFPS}'
		+ (backend.ClientPrefs.data.showTPS ? '\nTPS: ${backend.TPSMode.getDisplayString()}' : '')
